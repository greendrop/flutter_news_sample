...
import 'package:app/feature/app_log_list/riverpod/app_log_files_repository.dart';
    ...
    group('#fetch', () {
      testWidgets(
        ...
        (tester) async {
          ...
          await tester.pumpWidget(
            TestMaterialApp(
              providerScopeOverrides: [
                ...
                appLogFilesRepositoryProvider.overrideWithValue(
          ...
          when(
            () => appLogFilesRepository.fetch(directory: directory),
          ).thenAnswer(
            (_) async => [
              File('test1.log'),
              File('test2.txt'),
