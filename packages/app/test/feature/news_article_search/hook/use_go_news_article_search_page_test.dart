import 'package:app/feature/app_router/riverpod/news_article_search_route_data.dart';
import 'package:app/feature/app_router/route_data/app_route_data.dart';
import 'package:app/feature/news_article_search/hook/use_go_news_article_search_page.dart';
  ...
  group('useGoNewsArticleSearchPage', () {
    group('#run', () {
      testWidgets('NewsArticleSearchRouteData#goが呼ばれること', (tester) async {
        ...
        await tester.pumpWidget(
          TestMaterialApp(
            providerScopeOverrides: [
              newsArticleSearchRouteDataProvider.overrideWithValue(
        ...
        when(
          () => newsArticleSearchRouteData.go(builderContext),
        ).thenAnswer((_) async {});
