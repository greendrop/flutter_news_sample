...
import 'package:app/feature/news_api/repository/news_everything_repository.dart';
import 'package:app/feature/news_api/riverpod/news_everything_repository.dart';
      ...
      group("引数 keyword: 'keyword'", () {
        testWidgets(
          ...
          (tester) async {
            ...
            await tester.pumpWidget(
              TestMaterialApp(
                providerScopeOverrides: [
                  newsEverythingRepositoryProvider.overrideWithValue(
            ...
            when(
              () => newsEverythingRepository.get(query: 'keyword'),
